I wrote this because I keep seeing people writing text-based adventure games which have
...
If you want to do it properly, read Robert C. Martin's "Clean Code" amd then do it in
Java.
